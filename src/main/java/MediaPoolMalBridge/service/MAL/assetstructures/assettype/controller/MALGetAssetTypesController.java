...
public class MALGetAssetTypesController {
    ...
    private final MALGetAssetTypeService getAssetTypeService;

    public MALGetAssetTypesController(final MALGetAssetTypeService getAssetTypeService) {
        this.getAssetTypeService = getAssetTypeService;
    }

    @GetMapping("/service/mal/getAssetTypes")
    public void download() {
        getAssetTypeService.download();
    }
}
