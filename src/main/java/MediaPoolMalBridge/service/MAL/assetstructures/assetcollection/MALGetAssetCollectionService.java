...
@Service
public class MALGetAssetCollectionService extends AbstractMALUniqueService {

    private final MALGetCollectionsClient getCollectionsClient;

    private final MALAssetStructures malAssetStructures;

    public MALGetAssetCollectionService(final MALGetCollectionsClient getCollectionsClient,
