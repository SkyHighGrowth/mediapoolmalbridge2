                ...
                propertyVariant -> {
                    try {
                        ...
                        malPropertyEntities.forEach(malPropertyEntity -> {
                            ...
                            List<AssetEntity> assetEntities = assetRepository.findPropertyAssets(malPropertyEntity.getPropertyId(), "1", TransferringAssetStatus.DONE);
                            ...
                            for (final String mapColor : mapColors) {
                                assetEntities = assetRepository.findAssetDetails(malPropertyEntity.getPropertyId(), "5", mapColor, TransferringAssetStatus.DONE);
                                if (assetEntities != null && !assetEntities.isEmpty()) {
                                    assetEntities.forEach(assetEntity ->
                            ...
                            for (final String floorType : floorTypes) {
                                assetEntities = assetRepository.findAssetDetails(malPropertyEntity.getPropertyId(), "5", floorType, TransferringAssetStatus.DONE);
                                if (assetEntities != null && !assetEntities.isEmpty()) {
                                    assetEntities.forEach(assetEntity ->
