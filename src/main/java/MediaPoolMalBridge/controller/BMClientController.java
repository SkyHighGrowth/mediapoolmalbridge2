...
public class BMClientController {
    ...
    public DeleteMediaResponse deleteAsset(@RequestBody() final BMAsset bmAsset )
    {
        return bmDeleteAssetClient.delete( bmAsset );
    }

    @PostMapping( "/bm/getMediaDetails" )
    public DownloadMediaDetailsResponse getMediaDetails(@RequestBody() final BMAsset bmAsset )
    {
        return bmDownloadMediaDetailsClient.download( bmAsset );
    }

    @PostMapping( "/bm/uploadAsset" )
    public UploadStatus uploadAsset(@RequestBody() final BMAsset bmAsset )
    {
        return bmUploadAssetClient.upload( bmAsset );
    }

    @PostMapping( "/bm/uploadMetadata" )
    public UploadMetadataStatus uploadMetadata(@RequestBody() final BMAsset bmAsset )
    {
        return bmUploadMetadataClient.upload( bmAsset );
    }

    @PostMapping( "/bm/uploadAssetVersion" )
    public UploadStatus uploadAssetVersion( @RequestBody() final BMAsset bmAsset )
    {
